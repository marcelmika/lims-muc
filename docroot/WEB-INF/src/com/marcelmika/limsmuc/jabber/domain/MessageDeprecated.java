...
////        return com.marcelmika.limsmuc.service.BuddyLocalServiceUtil.getBuddyByScreenName(getCompanyId(), getFrom());
//    }

//    public Buddy getParticipant() {
//        String screenName = JabberUtil.getScreenName(getTo());
//        return com.marcelmika.limsmuc.service.BuddyLocalServiceUtil.getBuddyByScreenName(getCompanyId(), screenName);
//    }
    ...
    public JSONObject toJSON() {
        ...
        // Find buddy            
//        Buddy buddy = com.marcelmika.limsmuc.service.BuddyLocalServiceUtil.getBuddyByScreenName(getCompanyId(), getFrom());
//        if (buddy != null) {
