...
public class LogoutBuddyResponseEvent extends ResponseEvent {
     ...
     */
    private LogoutBuddyResponseEvent() {
        // No params
    }
     ...
     */
    public static LogoutBuddyResponseEvent success(final BuddyDetails buddyDetails) {
     ...
     * @return ResponseEvent
     */
    public static LogoutBuddyResponseEvent failure(final Status status) {
        LogoutBuddyResponseEvent event = new LogoutBuddyResponseEvent();
