...
import com.marcelmika.limsmuc.persistence.generated.service.SynchronizationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.marcelmika.limsmuc.persistence.generated.service.impl.SynchronizationLocalServiceImpl}.
 * </p>
 *
...
public abstract class SynchronizationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SynchronizationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.marcelmika.limsmuc.persistence.generated.service.SynchronizationLocalServiceUtil} to access the synchronization local service.
	 */
	...
	public Synchronization addSynchronization(Synchronization synchronization)
		...
		return synchronizationPersistence.update(synchronization);
	}
	 ...
	 */
	@Override
	public Synchronization createSynchronization(long sid) {
		return synchronizationPersistence.create(sid);
	}
	...
	@Override
	public Synchronization deleteSynchronization(long sid)
		throws PortalException, SystemException {
		return synchronizationPersistence.remove(sid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Synchronization deleteSynchronization(
		Synchronization synchronization) throws SystemException {
		return synchronizationPersistence.remove(synchronization);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Synchronization.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return synchronizationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return synchronizationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Synchronization fetchSynchronization(long sid)
		throws SystemException {
		return synchronizationPersistence.fetchByPrimaryKey(sid);
	}
	 ...
	 */
	@Override
	public Synchronization getSynchronization(long sid)
		throws PortalException, SystemException {
		return synchronizationPersistence.findByPrimaryKey(sid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return synchronizationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Synchronization> getSynchronizations(int start, int end)
		throws SystemException {
		return synchronizationPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSynchronizationsCount() throws SystemException {
		return synchronizationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Synchronization updateSynchronization(
		Synchronization synchronization) throws SystemException {
		return synchronizationPersistence.update(synchronization);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.marcelmika.limsmuc.persistence.generated.model.Synchronization",
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = synchronizationPersistence.getDataSource();
	...
	private SynchronizationLocalServiceClpInvoker _clpInvoker = new SynchronizationLocalServiceClpInvoker();
}